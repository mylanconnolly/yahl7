...
This release does some bugfixing

### Changed

- Strip input to messages and segments. This allows the file parsing to be more
  lenient with nonstandard line endings (like Windows EOFs, etc).

## [1.0.0] - 2022-03-08

This release adds the XPN type as well as some fixes around parsing IO streams.

### Changed

- The `XPN` data type can now handle repeated values.
